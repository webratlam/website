...
import { TestimonialsSlider2 } from "@/components/slider/TestimonialsSlider";
import { projectSliderActive } from "@/sliderProps";
...
export default function Home() {
  return (
    <Layout header={1}>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 align-self-end">
              <div className="hero-images mt-80 wow fadeInLeft delay-0-2s">
                ...
                <div className="about-btns mb-45">
                  ...
                  <div className="hotline mt-15">
                    ...
                    <div className="content">
                      <span>Hotline</span>
                      <br />
                      <a href="callto:+000(123)45688">+91 9926929561</a>
                    </div>
                  </div>
                </div>
      ...
      <section className="price-plan-area bgc-lighter pt-150"></section>
